  ...
  return (
    <div className="bg-dark-purple text-white px-6 py-12 lg:py-8 lg:px-24 w-full h-[90vh] lg:h-[85vh] flex justify-around flex-col lg:flex-row">
      <div className="w-full lg:w-2/5 hidden lg:block">
        <h2 className="text-2xl lg:text-4xl font-extrabold font-clash mb-6 text-lighter-purple">Get in touch</h2>
        <p className="font-montserrat text-lg mb-6">Contact Information</p>
        <p className="font-montserrat text-lg mb-6">27,Alara Street <br /> Yaba 100012 <br /> Lagos State</p>
        <p className="font-montserrat text-lg mb-6">Call Us : 07067981819</p>
        <p className="font-montserrat text-lg mb-6">we are open from  <br /> Monday-Friday 08:00am - 05:00pm</p>

        <div>
          <h3 className="font-montserrat text-lg mb-2 font-bold text-lighter-purple">Share On</h3>
          <div className='flex'>
              <img src={ig}/>
      ...
      <div className="w-full lg:w-2/5">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <input type="submit" className="px-12 py-3 rounded-xl text-xl background-gradient font-semibold mt-4 font-montserrat w-full lg:w-[200px]"/>
        </form>
